...
from workout.services.make_random_warmup import make_youth_random_warmup, make_random_others_warmup, \
    make_random_main, get_main_video_id, get_warm_up_video_id
...
def workout_view(request):
    ...
    if request.method == 'GET':
        if who.level == "":
            ...
            # picked_exercise=Exercise.objects.get(id=2528)
